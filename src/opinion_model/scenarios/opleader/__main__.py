...
def main() -> None:
    ...
    manifest = {
        ...
        "interpretation_note": (
            "The opleader-null contrast represents the joint opinion-leader "
            "package: initialized leader position and orientation, origination "
            "advantage, and source-dependent evidence weight."
        ),
    }
