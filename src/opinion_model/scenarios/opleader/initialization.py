...
def _initialization_streams(
    ...
    # This stream split must remain identical to main@1d8eaac and null@c142c46.
...
def _leader_orientations(
    ...
    if orientation == "positive":
        ...
        raise ValueError(f"Unknown opleader orientation: {orientation!r}")
...
def initialize_opleader(
    ...
    topology_seed, direction_rng, belief_rng, assignment_rng = (
